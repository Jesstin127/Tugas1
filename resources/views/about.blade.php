            ...
            <section id="services" class="s-services">
                ...
                <div class="row narrow section-header section-header--dark has-bottom-sep">
                    <div class="column lg-12">
                        <h1 class="text-display-title">Self-Description</h1>   

                        <p class="lead">I am a creative and professional design enthusiast with high attention to details who
                            translate design briefs into visual outcomes. I always open to new challenges to achieve
                            better designs.</p>
