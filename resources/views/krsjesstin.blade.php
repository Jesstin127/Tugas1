...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <table style="padding:0; margin:0;">
        <tr>
            <td><h4 style = 'color: black'>Nama</h4></td>
            ...
            <?php
                ...
                echo "<td><h4 style = 'color: black';>".$nama." </h4></td>";
            ?>

            </tr>

        <tr>
                <td><h4 style = 'color: black'>NIM</h4></td>
                ...
                <?php
                    ...
                    echo "<td><h4 style = 'color: black';>".$studentID."</h4></td>";
                ?>
        </tr>

        <tr>
            <td><h4 style = 'color: black'>Term</h4></td>
            <?php
            $term = DB::table('mahasiswa')
            ->where('id_mahasiswa', '3')
            ->value('term');

            echo "<td><h4 style = 'color: black';>".$term."</h4></td>";
        ?>
        </tr>
        ...
        <tr>
            <td><h4 style = 'color: black'>IP</h4></td>
    ...
    <table width="700px">
        ...
        <?php
            ...
            while ($no<10) {
                ...
                echo "<td style='text-align:center'; 'color: white';>".$NilaiHuruf."</td>";
                echo "</tr>";
